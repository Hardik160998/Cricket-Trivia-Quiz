  ...
  return (
    <main className="min-h-screen bg-background p-4 md:p-8">
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        {/* Balance Card */}
        <section className="glass-card p-6 md:p-12 rounded-[2rem] shadow-2xl relative overflow-hidden bg-slate-900 border-none group">
          ...
          <div className="relative z-10 flex flex-col lg:flex-row lg:items-center justify-between gap-10">
            <div className="space-y-2">
              ...
              <div className="flex items-baseline space-x-3">
                <span className="text-6xl md:text-8xl font-black text-white italic tracking-tighter tabular-nums leading-none">{balance}</span>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <button className="flex-1 sm:flex-none px-10 py-5 bg-white/5 text-white font-bold rounded-2xl border border-white/10 backdrop-blur-xl hover:bg-white/10 transition-all text-sm tracking-widest">HISTORY</button>
            </div>
          </div>
        </section>
